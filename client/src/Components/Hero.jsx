...
const Hero = () => {
  return (
    <div className='flex flex-col item-start justify-center px-6 md:px16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
      <p className="bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20 1 w-fit">
...
[56px] font-bold md:font-extrabold max-w-xl mt-4 "
      ...
      <p className="max-w-130 mt-2 text-sm md:text-base">
        Unparallel luxury and comfort await at the worlds most exclusive hotels
        and resorts.Start your career today.
      </p>
